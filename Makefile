...
autodoc:
	rm -rf doc/source
	sphinx-apidoc -eMT -o doc/source/ wbml
	rm doc/source/wbml.rst
...
test:
	python /usr/local/bin/nosetests tests --with-coverage --cover-html --cover-package=wbml --nologcapture -v
